...
def layer_norm(input_tensor, name=None):
  ...
  layer_norm = tf.keras.layers.LayerNormalization(epsilon=1e-12, name=name)
...
def embedding_postprocessor(input_tensor,
  ...
  if use_token_type:
    ...
    token_type_table = tf.Variable(
        ...
        initial_value=create_initializer(initializer_range)((token_type_vocab_size, width)))
  ...
  if use_position_embeddings:
    ...
    with tf.control_dependencies([assert_op]):
      full_position_embeddings = tf.Variable(
          ...
          initial_value=create_initializer(initializer_range)((max_position_embeddings, width)))
...
def attention_layer(from_tensor,
  ...
  print(f'from_tensor.shape={from_tensor.shape}')
  print(f'from_tensor_2d.shape={from_tensor_2d.shape}')
  ...
  # to_tensor_2d = tf.squeeze(to_tensor_2d, axis=0)
  query_layer = tf.keras.layers.Dense(
    units=num_attention_heads * size_per_head,
    activation=query_act,
    name="query",
    kernel_initializer=create_initializer(initializer_range)
  )(tf.cast(to_tensor_2d, dtype=tf.int32))
